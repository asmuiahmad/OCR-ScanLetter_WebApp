...
function generateDetailContent(cuti) {
  ...
  // Generate document preview section if pdf_path exists
  let documentPreview = "";
  if (cuti.pdf_path) {
    const filePath = `/static/${cuti.pdf_path}`;
    const fileExtension = cuti.pdf_path.split(".").pop().toLowerCase();

    if (fileExtension === "pdf") {
      documentPreview = `
                <div class="row mt-3">
                    <div class="col-12">
                        <h6><strong>Dokumen Upload</strong></h6>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <div class="border rounded p-2 text-center" style="background-color: #f8f9fa;">
                            <img src="${filePath}" alt="Dokumen Cuti" style="max-width: 100%; height: auto; max-height: 500px;" class="img-fluid">
                            <div class="text-center mt-2">
                                <a href="${filePath}" target="_blank" class="btn btn-sm btn-primary">
                                    <i class="fas fa-external-link-alt"></i> Buka di Tab Baru
                                </a>
