/**
 * OCR Modal Functionality for Surat Keluar
 * Enhanced modal with image zoom, pan, and form handling
 */

class OCRModalSuratKeluar {
    ...
    fillFormWithData(data) {
        ...
        // Field mappings for surat keluar
        const fieldMappings = {
            ...
            'acara_suratKeluar': data['acara'] || '',
            'tempat_suratKeluar': data['tempat'] || '',
        ...
        this.handleDateField('tanggal_acara_suratKeluar', data['tanggal_acara']);
        this.handleTimeField('jam_suratKeluar', data['jam']);
...
window.OCRModalSuratKeluar = OCRModalSuratKeluar;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize OCR Modal for Surat Keluar
    if (extractedDataList.length > 0) {
        new OCRModalSuratKeluar(extractedDataList, imagePaths);
    }
});