...
class SuratKeluarForm(FlaskForm):
    ...
    image = FileField("Gambar Surat", validators=[])
...
class SuratMasukForm(FlaskForm):
    ...
    tanggal_acara_suratMasuk = DateField(
        "Tanggal Acara", format="%Y-%m-%d", validators=[], default=None
    )
